...
% can differ from those used in the original calculations. This file first
% calculates axial force Fz vs. z, then also checks lateral force Fx vs. x.
...
% 
% Unlike the other files in the package, the lateral forces here are
% calculated at the axial trapping site rather than fixed at z=0.
%
...
% Now what grid do we want to evaluate this over?
Nmax=26;
N_theta=100;
N_phi=120;


%Can comment this out if they are still in workspace.
% radius=6/1.6; 
% NA=1.25;
% n_medium = 1.33; % Water
